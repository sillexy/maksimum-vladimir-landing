(() => {
  ...
  if (leadRoot) {
    ...
    if (contactMount) {
      ...
      title.className = 'offline-consultation-contacts__title';
      title.textContent = 'Как еще с нами можно связаться';

      const links = document.createElement('div');
      links.className = 'offline-consultation-contacts__links';
      links.innerHTML = `
